...
pub fn start (bam: &mut IndexedReader, chromosome: &str, start: usize, end: usize, primary_only: bool, output_path: String) -> AnyhowResult<()>   {
    let (reads, read_coordinates, read_sequence_dictionary, bam_records) = intervals::extract_haplotypes_coordinates_from_bam(
        bam,
        &chromosome,
        start as u64,
        end as u64,
