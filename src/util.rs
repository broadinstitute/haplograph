...
) -> AnyhowResult<(Vec<fastq::Record>, HashMap<String, (u64, u64)>)> {
...
/// Extract read names and sequences from a BAM file
pub fn extract_read_sequences(bam: &mut IndexedReader) -> AnyhowResult<HashMap<String, String>> {
